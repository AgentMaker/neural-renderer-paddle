...
import neural_renderer_paddle.cuda.create_texture_image as create_texture_image_cuda
...
def create_texture_image(textures, texture_size_out=16):
    ...
    image = paddle.zeros([tile_height * texture_size_out, tile_width * texture_size_out, 3], dtype=paddle.float32)
    vertices = paddle.zeros([num_faces, 3, 2], dtype=paddle.float32)  # [:, :, XY]
